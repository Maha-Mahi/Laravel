                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="order-status"><a href="return.html" class="btn btn-theme btn-theme-dark">Return Order</a> <a href="#" class="btn btn-theme btn-theme-dark">Re Order</a> </td>
                                                </tr>
                                                <tr>
                                                    <td class="image"><a href="#" class="media-link"><i class="fa fa-plus"></i><img alt="" src="assets/img/preview/shop/order-1.jpg"></a></td>
                                                    <td class="quantity">x3</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="order-id"> OD31207 </td>
                                                    <td class="diliver-date"> 12th Dec'13 </td>
                                                    <td class="order-status">  <span class="return-request"> You requested </br> this order for return </span> <a href="#" class="btn btn-theme btn-theme-dark">Re Order</a> </td>
                                                </tr>
                                            </tbody>
                                        </table>
